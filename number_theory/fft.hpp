...
private:
     ...
     */
    static inline std::vector<complex> fft_roots = {complex(0, 0), complex(1, 0)};
    ...
    friend inline void fft::forward_backward_fft(complex* p1, complex* p2, const std::size_t n);
};
