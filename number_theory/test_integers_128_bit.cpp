...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<volatile uint128_t>, volatile uint128_t>);
...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<const volatile uint128_t>, const volatile uint128_t>);
static_assert(std::is_same_v<int128_traits::make_signed_t<const volatile uint128_t>, const volatile int128_t>);
...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<volatile int128_t>, volatile uint128_t>);
...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<const volatile int128_t>, const volatile uint128_t>);
static_assert(std::is_same_v<int128_traits::make_signed_t<const volatile int128_t>, const volatile int128_t>);
...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<const volatile uint64_t>, const volatile uint64_t>);
static_assert(std::is_same_v<int128_traits::make_signed_t<const volatile uint64_t>, const volatile int64_t>);
...
static_assert(std::is_same_v<int128_traits::make_unsigned_t<const volatile int64_t>, const volatile uint64_t>);
static_assert(std::is_same_v<int128_traits::make_signed_t<const volatile int64_t>, const volatile int64_t>);
...
template <class T>
[[nodiscard]] bool test_int128_to_string_test_case(const T value, const std::string_view expected_str) {
...
void test_int128_to_string() {
    ...
    for (uint64_t n = std::numeric_limits<uint64_t>::max(); n >= std::numeric_limits<uint64_t>::max() - k; n--) {
        assert(test_int128_to_string_test_case(uint128_t{n}, std::to_string(n)));
        assert(test_int128_to_string_test_case(int128_t{n}, std::to_string(n)));
    }

    for (int64_t n = std::numeric_limits<int64_t>::min(); n <= std::numeric_limits<int64_t>::min() + int64_t{k}; n++) {
        assert(test_int128_to_string_test_case(int128_t{n}, std::to_string(n)));
    }
...
#pragma GCC diagnostic warning "-Wno-alloc-size-larger-than"
    ...
    assert(test_int128_to_string_test_case(static_cast<uint128_t>(-1), "340282366920938463463374607431768211455"));
    assert(test_int128_to_string_test_case(uint128_t{1} << 127U, "170141183460469231731687303715884105728"));
