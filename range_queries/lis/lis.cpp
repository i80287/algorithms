    ...
    requires std::is_arithmetic_v<T>
{
    ...
    return static_cast<std::size_t>(std::lower_bound(dp.begin(), dp.end(), std::numeric_limits<T>::max()) - dp.begin());
}
...
int main() {
    ...
    longest_increasing_subsequence(std::array{
        4,   23,    88,   37,   28,  72,  3,  478, 27,  3,   438, 47,  239,  84,  342, 4,    23, 423, 4234,
        3,   67824, 32,   4723, 7,   47,  68, 23,  6,   324, 37,  8,   7462, 34,  7,   2348, 7,  48,  246,
        728, 164,   2,    83,   4,   21,  0,  74,  284, 50,  21,  34,  5,    342, 58,  74,   28, 7,   46,
        28,  74,    5234, 7234, 75,  342, 36, 4,   24,  264, 2,   187, 4,    50,  18,  7,    5,  1,   7,
        243, 42,    34,   4,    234, 25,  8,  46,  0,   14,  67,  5,   13,   587, 51,  7,    48, 56,
    });
}
