...
std::vector<string_view> Search(string_view text, string_view query,
    ...
    size_t total_lines = act.RunTextCountLines<IsExactWordsMatching>(
        text,
        ...
        [&query_words_on_lines](
            ...
            size_t line_start_index, size_t line_end_index) constexpr noexcept {
    ...
    std::stable_sort(
        ...
        [](const std::pair<double, size_t>& p1,
           const std::pair<double, size_t>& p2) constexpr noexcept -> bool {
