...
static_assert(misc::get_typename<ns1::S>() == "ns1::S");
static_assert(misc::get_typename<ns1::ns2::C1::C2::C3>() == "ns1::ns2::C1::C2::C3");
...
int main() {
    ...
    assert(misc::get_typename<ns1::S>() == "ns1::S");
    assert(misc::get_typename<ns1::ns2::C1::C2::C3>() == "ns1::ns2::C1::C2::C3");
    assert(std::string{misc::get_typename<ns1::ns2::C1::C2::C3>()} == "ns1::ns2::C1::C2::C3");
